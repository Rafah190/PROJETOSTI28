...
ALTER TABLE tb_vendas ADD CONSTRAINT ven_cli_id FOREIGN KEY (fk_cli_id) REFERENCES tb_clientes(cli_id);
ALTER TABLE tb_vendas ADD CONSTRAINT ven_usu_id FOREIGN KEY (fk_usu_id) REFERENCES tb_usuarios(usu_id);