...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //VERIFICA S PÃO DE QUEIJO EXISTE
    ...
    if ($contagem == 0) {
        ...
        $retorno = mysqli_query($link, $sql); # CRÉDITOS PARA MIM GÊNIO E HUMILDE
...
<body>
    <div class="container-global">
        <form class="formulario" action="produto-cadastro.php" method="post">
            ...
            <input type="text" name="txtnome" placeholder="DIGITE NOME DO PRODUTO" required>
            <br>
